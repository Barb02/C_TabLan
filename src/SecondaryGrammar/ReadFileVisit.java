...
public class ReadFileVisit extends ReadCsvFileBaseVisitor<String> {
    Map<String, ArrayList<String>> dadosFicheiro = new HashMap<String, ArrayList<String>>();  // Map of all values
    ...
    public String visitProgram(ReadCsvFileParser.ProgramContext ctx) {
        ...
        for (Map.Entry<String, ArrayList<String>> entry : dadosFicheiro.entrySet()) {
    ...
    public String visitLine(ReadCsvFileParser.LineContext ctx) {
        ...
        for (Map.Entry<String, String> entry : valores.entrySet()) {
            ...
            dadosFicheiro.computeIfAbsent(header, k -> new ArrayList<String>()).add(valor);
        }
